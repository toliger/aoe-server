...
func TestCreation(t *testing.T) {
	...
	if d.IDMap.GetIDFromObject(player1.GetPointerNpc(0)) != d.IDMap.GetIDFromObject(&vill1) || d.IDMap.GetIDFromObject(player2.GetPointerNpc(0)) != d.IDMap.GetIDFromObject(&vill2) {
